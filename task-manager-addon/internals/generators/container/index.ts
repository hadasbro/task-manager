...
const rootStatePath = path.join(__dirname, '../../../src/types/RootStateSla.ts');
  ...
  actions: (data: { [P in ContainerProptNames]: string }) => {
    ...
    const actions: Actions = [
      {
        ...
        templateFile: './container/BackofficePage.tsx.hbs',
        abortOnFail: true,
      },
    ];
    ...
    if (data.wantSlice) {
      ...
      actions.push({
        ...
        templateFile: './container/globalTypes.ts.hbs',
        abortOnFail: true,
      });
      actions.push({
        type: 'modify',
    ...
    if (data.wantSaga) {
      actions.push({
        ...
        templateFile: './container/tasksListLoadSaga.ts.hbs',
        abortOnFail: true,
      });
    }
