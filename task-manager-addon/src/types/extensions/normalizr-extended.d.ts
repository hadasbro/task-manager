...
// extended normalizr declarations //

declare module 'normalizr' {
  namespace schema {
    export type StrategyFunction<T, S> = (value: S, parent: any, key: string) => T;
    export type SchemaFunction = (value: any, parent: any, key: string) => string;
    export type MergeFunction = (entityA: any, entityB: any) => any;
    export type FallbackFunction<T, S> = (key: S, schema: schema.Entity<T>) => T;
    ...
    export interface EntityOptions<T = any, S> {
      idAttribute?: string | SchemaFunction;
      mergeStrategy?: MergeFunction;
      processStrategy?: StrategyFunction<T, S>;
      fallbackStrategy?: FallbackFunction<T, S>;
    }

    export class Entity<T = any> {
      constructor(key: string | symbol, definition?: Schema, options?: EntityOptions<T, S>);
      ...
      _processStrategy: StrategyFunction<T, S>;
    }
  ...
  export type Schema<T = any, S = any> =
    | schema.Entity<T, S>
    | schema.Object<T>
    | schema.Union<T>
    | schema.Values<T>
